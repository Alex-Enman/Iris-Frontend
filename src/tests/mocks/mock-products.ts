...
export const MOCK_PRODUCTS: Product[] = [
  ...
  {
    id: '7',
    name: 'Potatoes (10 kg batch)',
    description: 'Washed potatoes sold in 10 kg batches, ideal for kitchens',
    category: ProductCategory.PRODUCE,
    pricingMode: 'batch',
    batchWeightKg: 10,
    batchPriceSek: 240,
    ...
    unit: 'kg',
    image:
      'https://images.unsplash.com/photo-1518977676601-b53f82aba655?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwb3RhdG9lc3xlbnwxfHx8fDE3NjEzMDczNDh8MA&ixlib=rb-4.1.0&q=80&w=1080',
    supplierId: '1',
    supplierName: 'Green Valley Farm',
    isAvailable: true,
    stockQuantity: 40,
    minimumOrderQuantity: 1,
    tags: ['Local', 'Staple', 'Batch'],
    createdAt: '2023-06-10T08:00:00Z',
    updatedAt: '2024-02-10T10:30:00Z',
  },
  {
    id: '8',
    name: 'Frozen Wild Blueberries (5 kg batch)',
    description: 'IQF wild blueberries sold in 5 kg batches',
    category: ProductCategory.PRODUCE,
    pricingMode: 'batch',
    batchWeightKg: 5,
    batchPriceSek: 325,
    ...
    unit: 'kg',
    image:
      'https://images.unsplash.com/photo-1464965911861-746a04b4bca6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxibHVlYmVycmllc3xlbnwxfHx8fDE3NjEzMDczNDl8MA&ixlib=rb-4.1.0&q=80&w=1080',
    supplierId: '5',
    supplierName: 'Artisan Bakery',
    isAvailable: true,
    stockQuantity: 25,
    minimumOrderQuantity: 1,
    tags: ['Frozen', 'Premium', 'Batch'],
