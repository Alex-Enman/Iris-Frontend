        ...
        <div className="w-full max-w-md">
          ...
          <div className="overflow-hidden rounded-3xl bg-white shadow-[0_8px_32px_rgba(0,0,0,0.12)]">
            <div className="bg-gradient-to-br from-primary/5 to-accent/5 p-6">
              <h2 className="text-center text-2xl text-primary">Welcome Back</h2>
            </div>
            ...
            <form onSubmit={handleSubmit} className="p-8">
              <div className="space-y-5">
                ...
                <Button
                  type="submit"
                  disabled={loading}
                  className="h-12 w-full rounded-xl bg-primary text-primary-foreground transition-all duration-250 hover:bg-primary/90 hover:shadow-[0_4px_12px_rgba(45,77,49,0.3)]"
                >
          ...
          <div className="mt-8">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <button
                ...
                className="group rounded-2xl bg-white p-4 shadow-[0_2px_8px_rgba(0,0,0,0.08)] transition-all duration-250 hover:shadow-[0_4px_16px_rgba(0,0,0,0.12)] hover:-translate-y-1"
              >
