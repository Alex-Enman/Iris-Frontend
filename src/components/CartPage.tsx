          ...
          <div className="lg:col-span-2">
            <div className="space-y-4">
              {cartItems.map((item) => (
                <div
                  key={item.id}
                  className="group overflow-hidden rounded-2xl bg-white p-6 shadow-[0_1px_4px_rgba(0,0,0,0.08)] transition-all duration-250 hover:shadow-[0_2px_8px_rgba(0,0,0,0.12)]"
                >
                  <div className="flex gap-6">
                    ...
                    <button
                      ...
                      className="h-fit rounded-lg p-2 text-muted-foreground opacity-0 transition-all duration-250 hover:bg-destructive/10 hover:text-destructive group-hover:opacity-100"
                    >
            ...
            <div className="sticky top-24 space-y-6">
              ...
              <div className="overflow-hidden rounded-2xl bg-white p-6 shadow-[0_2px_8px_rgba(0,0,0,0.08)] backdrop-blur-sm">
                ...
                <Button
                  ...
                  className="w-full h-12 rounded-xl bg-primary text-primary-foreground transition-all duration-250 hover:bg-accent hover:shadow-[0_4px_12px_rgba(197,108,74,0.3)]"
                >
                  Proceed to Checkout
                </Button>
